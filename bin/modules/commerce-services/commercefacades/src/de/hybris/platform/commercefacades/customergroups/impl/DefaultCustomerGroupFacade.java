...
public class DefaultCustomerGroupFacade implements CustomerGroupFacade
{
	...
	{
		validateParameterNotNullStandardMessage("customerGroupId", customerGroupId);
	...
	{
		return getUserMatchingService().getUserByProperty(userId, UserModel.class);
	}

	@Override
	public List<UserGroupData> getCustomerGroupsForUser(final String userId)
	{
		final UserModel user = getUserById(userId);
