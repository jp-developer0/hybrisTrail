...
public abstract class GeneratedBundleTemplate extends GenericItem
{
	...
	**/
	...
	true,
	CollectionType.LIST
	).withRelationCode("BundleTemplateRelation");
	/**
	...
	**/
	...
	true,
	CollectionType.LIST
	).withRelationQualifier("childTemplates").withRelationCode("BundleTemplateRelation");
	/**
	...
	**/
	...
	).withRelationQualifier("changeProductPriceBundleRules");
	/**
	...
	**/
	...
	true,
	CollectionType.COLLECTION
	).withRelationQualifier("disableProductBundleRules");
	/**
