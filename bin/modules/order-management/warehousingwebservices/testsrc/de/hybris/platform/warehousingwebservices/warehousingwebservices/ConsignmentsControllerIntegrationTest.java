...
public class ConsignmentsControllerIntegrationTest extends BaseWarehousingWebservicesIntegrationTest
{
	...
	public void reallocateConsignment()
	{
		...
		//When
		final Response result = postDefaultSecuredRestCall("consignments/con_0/reallocate", WAREHOUSE_AGENT_USERNAME,
				WAREHOUSE_AGENT_PASSWORD, DEFAULT_FIELDS, consignmentReallocationWsDTO);
	...
	public void pickConsignmentWhenPrintSlipIsFalse() throws ImpExException
	{
		...
		//When
		final Response result = postPickConsignmentWithPrintSlip(CONSIGNMENT_0, WAREHOUSE_AGENT_USERNAME, WAREHOUSE_AGENT_PASSWORD,
				"false");
	...
	public void packConsignmentWhenPrintSlipIsFalse() throws ImpExException
	{
		...
		//When
		final Response result = postPackConsignmentWithPrintSlip(CONSIGNMENT_0, WAREHOUSE_AGENT_USERNAME, WAREHOUSE_AGENT_PASSWORD,
				"false");
	...
	public void getExportForm() throws ImpExException
	{
		...
		//When
		final Response result = getEmptySecuredRestCall("consignments/con_0/export-form", WAREHOUSE_AGENT_USERNAME,
	...
	public void getShippingLabel() throws ImpExException
	{
		...
		//When
		final Response result = getEmptySecuredRestCall("consignments/con_0/shipping-label", WAREHOUSE_AGENT_USERNAME,
				WAREHOUSE_AGENT_PASSWORD);
	...
	public void getReturnShippingLabel() throws ImpExException
	{
		...
		//When
		final Response result = getEmptySecuredRestCall("consignments/con_0/return-shipping-label", WAREHOUSE_AGENT_USERNAME,
				WAREHOUSE_AGENT_PASSWORD);
	...
	public void getReturnForm() throws ImpExException
	{
		...
		//When
		final Response result = getEmptySecuredRestCall("consignments/con_0/return-form", WAREHOUSE_AGENT_USERNAME,
				WAREHOUSE_AGENT_PASSWORD);
	...
	public void consolidatedPickSlip() throws ImpExException
	{
		...
		//When
		final Response result = postBodySecuredRestCall("consignments/consolidated-pick", WAREHOUSE_AGENT_USERNAME,
				WAREHOUSE_AGENT_PASSWORD, consignmentCodes);
